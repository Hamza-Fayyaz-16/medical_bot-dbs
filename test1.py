...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="CUSTOMER",bg="#212121",fg="white",font=('Amigos',30),width=25,height=3,
                            command=lambda: controller.show_frame("PageTwo"))
        button2 = tk.Button(self, text="ADMIN",font=('Amigos',30),fg="white",width=25,height=3,bg="#212121",
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label.pack(side="top", fill="x", pady=30)
        button1 = tk.Button(self, text="LOGIN",width=10,height=3,bg='#212121',fg='white',font=('Amigos',25),
                            command=lambda: controller.show_frame("PageThree"))
        button2 = tk.Button(self, text="SIGN UP",width=10,height=3,bg='#212121',fg='white',font=('Amigos',25),
                            command=lambda: controller.show_frame("PageZero"))
        button1.place(relx=.3, rely=.5, anchor="c")
        button2.place(relx=.7, rely=.5, anchor="c")
        button3 = tk.Button(self, text="BACK",width=7,height=2,fg="#212121",bg="white",font=('Showcard Gothic',15),
...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="LOGIN",width=10,height=3,fg='white',bg="#212121",font=('Amigos',30),
                            command=up)    
        button1.place(relx=.6, rely=.7, anchor="c")
        button3 = tk.Button(self, text="BACK",width=10,height=3,fg='white',bg="#212121",font=('Amigos',30),
                            command=lambda: controller.show_frame("PageTwo"))
...
class PageZero(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="CREATE ACC", bg="#212121",fg='white',font=("Amigos",17),
                            command=val)
        button1.place(relx=.5, rely=.8, anchor="c")
        button3 = tk.Button(self, text="BACK",width=7,height=3,fg="#212121",bg="white",font=('Amigos',10),
                            command=lambda: controller.show_frame("PageTwo"))
        button3.place(relx=.1, rely=.1, anchor="c")
...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label5.pack(side="top", fill="x", pady=30)
        button1 = tk.Button(self, text="BOOK  RESTAURANT",width=25,height=3,bg="#212121",fg="white",font=('Amigos',25),
                            command=lambda: controller.show_frame("PageFive"))
        
        button2 = tk.Button(self, text="REVIEW  RESTAURANT",width=25,height=3,bg="#212121",fg="white",font=('Amigos',25),
        ...
        button3 = tk.Button(self, text="BACK",width=7,height=3,fg="#212121",bg="white",font=('Amigos',10),
                            command=lambda: controller.show_frame("PageThree"))
        button3.place(relx=.1, rely=.1, anchor="c")
        button3 = tk.Button(self, text="LOGOUT",width=7,height=3,fg="#212121",bg="white",font=('Amigos',10),
                            command=lambda: controller.show_frame("PageOne"))
...
class PageFive(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Proceed to get list of available restaurant",width=30,height=3,bg="#212121",fg="white",font=('Amigos',25),
                            command=cc)
...
class PageSix(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button3 = tk.Button(self, text="BACK",width=7,height=3,bg="white",font=('Amigos',10),
                            command=lambda: controller.show_frame("PageFive"))
        button3.place(relx=.1, rely=.1, anchor="c")
...
class PageSeven(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="main menu",bg='#212121',fg='white',font=('Amigos',50),
                            command=lambda: controller.show_frame("PageFour"))
        button2 = tk.Button(self, text="logout",bg='#212121',fg='white',font=('Amigos',50),
                            command=lambda: controller.show_frame("PageOne"))
...
class PageEight(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label5 = tk.Label(self, text="Customer", fg="#212121",bg='white',font=("Amigos",40))
        label5.pack(side="top", fill="x", pady=30)
        label5 = tk.Label(self, text="Restaurant id", width=20,height=3,bg="#212121",fg="white",font=('Amigos',25),)
        label5.place(relx=.4, rely=.4, anchor="c")
        ri=tk.StringVar()
        entry6=tk.Entry(self,textvariable=ri,width=25)
        entry6.place(relx=.6, rely=.4, anchor="c")
        label7 = tk.Label(self, text="Feedback",width=20,height=3,bg="#212121",fg="white",font=('Amigos',25),)
        ...
        button2 = tk.Button(self, text="submit",width=10,height=2,bg="#212121",fg="white",font=('Amigos',20),
                            command=fb1)
...
class PageNine(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="LOG IN",width=10,height=3,fg='white',bg="#212121",font=('Amigos',30),command=adminlog)
        button1.place(relx=.6, rely=.7, anchor="c")
        button3 = tk.Button(self, text="BACK",width=10,height=3,fg='white',bg="#212121",font=('Amigos',30),
                            command=lambda: controller.show_frame("PageOne"))
        button3.place(relx=.4, rely=.7, anchor="c")
...
class PageTen(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="ADD   RESTAURANT",width=25,height=3,bg="#212121",fg="white",font=('Showcard Gothic',25,),
                            command=lambda: controller.show_frame("PageEleven"))
        button2 = tk.Button(self, text="REMOVE   RESTAURANT",width=25,height=3,bg="#212121",fg="white",font=('Showcard Gothic',25),
                            command=lambda: controller.show_frame("PageThirteen"))
        
        button3 = tk.Button(self, text="VIEW   RESTAURANT",width=25,height=3,bg="#212121",fg="white",font=('Showcard Gothic',25),
                            command=lambda:controller.show_frame("PageFifteen"))
        button4 = tk.Button(self, text="VIEW   BOOKING",width=25,height=3,bg="#212121",fg="white",font=('Showcard Gothic',25),
                            command=lambda: controller.show_frame("PageSixteen"))
        button5 = tk.Button(self, text="VIEW   REVIEW",width=25,height=3,bg="#212121",fg="white",font=('Showcard Gothic',25),
        ...
        button3 = tk.Button(self, text="BACK",width=7,height=3,bg="#212121",fg="white",font=('Showcard Gothic',10),
                            command=lambda: controller.show_frame("PageNine"))
        button3.place(relx=.1, rely=.1, anchor="c")
        button3 = tk.Button(self, text="LOGOUT",width=7,height=3,bg="#212121",fg="white",font=('Showcard Gothic',10),
                            command=lambda: controller.show_frame("PageOne"))
        button3.place(relx=.9, rely=.1, anchor="c")
...
class PageEleven(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button3 = tk.Button(self, text="BACK",width=7,height=3,font=('Amigos',10),
                            command=lambda: controller.show_frame("PageTen"))
        button3.place(relx=.1, rely=.1, anchor="c")
        button3 = tk.Button(self, text="LOGOUT",width=7,height=3,font=('Amigos',10),
                            command=lambda: controller.show_frame("PageOne"))
        button3.place(relx=.9, rely=.1, anchor="c")
...
class PageThirteen(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="remove",bg='#212121',fg='white',font=('Amigos',30),command=greet)
        button1.place(relx=.5, rely=.8, anchor="c")
        button3 = tk.Button(self, text="BACK",width=7,height=3,font=('Amigos',10),
                            command=lambda: controller.show_frame("PageTen"))
        button3.place(relx=.1, rely=.1, anchor="c")
